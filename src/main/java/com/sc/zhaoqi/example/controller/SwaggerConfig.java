...
//@ComponentScan(basePackages = "beans")//扫描control
@Configuration
@EnableSwagger2
@EnableWebMvc
public class SwaggerConfig
{
    ...
    public Docket api()
    {
        System.out.println("当前类=SwaggerConfig.api()");
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.sc.zhaoqi.example.controller"))
